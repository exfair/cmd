...
# if you run "bash build-firefox-portable.sh esr" you get a portable version for the latest version of Firefox "ESR"
#
# Changelog
# - 0.2 : fixed a bug
# - 0.1 : initial release
...
cd /tmp
wget "https://download.mozilla.org/?product=firefox${FOXVER}-latest&os=${FSYS}${FVER}&lang=tr" -O firefox.tar.bz2
